...
//        Optional<UserStats> userStatOptional = userStatsRepository.findByUserId(userId);
...
//
//
//        UserStats userStats = userStatOptional.get();
//        userStats.setSelectedStat(selectedStat);
